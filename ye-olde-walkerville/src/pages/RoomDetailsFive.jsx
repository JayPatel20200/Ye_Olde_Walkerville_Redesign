...
import RoomFiveSlider from '../components/RoomFiveSlider';
  ...
  return (
    ...
    <div class="grid grid-flow-row-dense grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div class="content p-3">
        ...
        <p>Room #5</p>
        <p class="mt-7">Deanna's Room is more than just a place to lay your head; it's an indulgent space designed for those who appreciate the luxury of generous proportions.
        Reserve Deanna's Room today and step into an environment where affordability meets elegance. This isn't just a room; it's an invitation to a refined experience where every detail is curated for your pleasure.
        <br /> Book now to discover the allure of Deanna's Room and make it your haven of comfort and sophistication.
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <select id="price" name="price" autocomplete="room-price" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              <option>Room Only - from $134</option>
              <option>Room with Breakfast - from $144</option>
            </select>
          </div>
        </div>
         <div class="sm:col-span-3">
...
export default RoomDetailsFive